    ...
    <>
      <div className="flex flex-col items-center justify-center bg-white py-10 lg:h-screen lg:flex-row lg:py-0">
        ...
        <div className="relative mt-10 lg:-mt-32 lg:pl-28">
          <div className="cartoon-shadow bg-green z-10 flex h-40 w-40 flex-col items-center justify-center rounded-full font-coolvetica">
            <h1 className="text-4xl">01+</h1> <h6>Experience</h6>
          </div>
          <div className="cartoon-shadow bg-yellow absolute left-16 top-28 z-10 flex h-40 w-40 flex-col items-center justify-center rounded-full font-coolvetica">
